...
class UserDAO {
    ...
    public function createUser($DbConfig, $User) {
        ...
        // SQL statement
        $statement = "INSERT INTO hotel_login (id, fullname, username, email, password, address)". "VALUES ('".$User->getId()."', '".$User->getFullname()."', '".$User->getUsername()."', '".$User->getEmail()."', '".$User->getPassword()."', '".$User->getAddress()."')";
    ...
    public function readByUsername($DbConfig, $username, $password) {
        ...
        // SQL statement
        $statement = "SELECT * FROM `hotel_login` WHERE `username` ='$username'";
    ...
    public function readAll($DbConfig) {
        ...
        $statement = "SELECT * FROM `hotel_login`";
        ...
        if ($result = $connection->query($statement)) {
            ...
            while($row = $result->fetch_object()) {
                ...
                $userObject = new User($row->username,$row->password,$row->email,$row->fullname, $row->address);
    ...
    function updateById($DbConfig, $id, $username, $password, $email, $address, $fullname) {
        ...
        $statement = "  UPDATE `hotel_login` 
                        SET username='$username', password='$password' , email='$email' , fullname='$fullname', address='$address'
                        WHERE id='$id'";
    ...
    function deleteById($DbConfig, $id) {
        ...
        $statement = "DELETE FROM `hotel_login` WHERE id=$id";
